...
namespace Lexicon.WebUI.Identity
{
    public class UserStore : IUserLoginStore<IdentityUser, Guid>, IUserClaimStore<IdentityUser, Guid>, IUserRoleStore<IdentityUser, Guid>, IUserPasswordStore<IdentityUser, Guid>, IUserSecurityStampStore<IdentityUser, Guid>, IUserStore<IdentityUser, Guid>, IDisposable
    {
        ...
        public Task AddLoginAsync(IdentityUser user, UserLoginInfo login)
        {
            ...
            var l = new Core.Entities.ExternalLogin
            {
        ...
        private Core.Entities.User getUser(IdentityUser identityUser)
        {
        ...
        private void populateUser(Core.Entities.User user, IdentityUser identityUser)
        {
        ...
        private IdentityUser getIdentityUser(Core.Entities.User user)
        {
            if (user == null)
                return null;
        ...
        private void populateIdentityUser(IdentityUser identityUser, Core.Entities.User user)
        {
